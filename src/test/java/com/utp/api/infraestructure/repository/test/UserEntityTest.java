...
public class UserEntityTest {
    ...
    public void setUp() {
        ...
        noteEntity.setId(1L);
        noteEntity.setScore(18.5);
        noteEntity.setDescription("Examen final");
    }
    ...
    public void testNotesRelationship() {
        ...
        assertEquals(18.5, userEntity.getNotes().get(0).getScore());
        assertEquals("Examen final", userEntity.getNotes().get(0).getDescription());
        
        // Modificar la lista de notas
        NoteEntity anotherNote = new NoteEntity();
        anotherNote.setId(2L);
        anotherNote.setScore(16.0);
        anotherNote.setDescription("Práctica de laboratorio");
        notes.add(anotherNote);
        userEntity.setNotes(notes);
        
        // Verificar que la lista de notas se actualizó correctamente
        assertEquals(2, userEntity.getNotes().size());
        assertEquals(16.0, userEntity.getNotes().get(1).getScore());
        assertEquals("Práctica de laboratorio", userEntity.getNotes().get(1).getDescription());
    }
